  ...
  render() {
    return (
      <div>
        ...
        <p>
          Provides a declarative way to specify document.title in a single-page
          app. This component can be used on server side as well.
        </p>
        ...
        <p>
          You can set the document title after the component has rendered using{" "}
          <b>document.title.</b>
        </p>
        <br />
        <h2>React Helmet</h2>
        <p>
          ...
          document head. You can use this as well to set your title of your page
          as well.
        </p>
